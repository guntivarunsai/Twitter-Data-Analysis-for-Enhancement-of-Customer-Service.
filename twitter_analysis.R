...
library(httr)
#Application Details
APIKey="Av57SzksBJUC7DVyxlnPqSrqJ"
APISecret="CcHcLNDWfeSWBsDGfeVVTg7r9TJ8TCQ3KXnTcdqQvgvuAFqpeD"
AccessToken="291732148-i11DB10BufaRpAx3Rj3cw9pXPF4qBPs2SXcwdfyq"
AccessTokenSecret="Q7iAZdKnihYmeDOENOn9A50Q2HAjncyDcB5LzpgHBlKZq"
...
get<-fetchHashtag("#Cognizant",200) # fetching tweets of coca cola
